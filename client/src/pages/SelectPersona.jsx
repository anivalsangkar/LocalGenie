...
const SelectPersona = () => {
  ...
  const handleSelect = (persona) => {
    ...
    // ✅ persist immediately so Home can read it reliably
    localStorage.setItem("persona", persona); // "relocating" | "exploring"
  };

  const handleGetStarted = () => {
    if (!selectedPersona) return;
    // ✅ ensure it's saved (in case user blocked the first write)

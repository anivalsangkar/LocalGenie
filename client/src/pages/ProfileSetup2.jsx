...
function ProfileSetup2() {
  ...
  const routerState = useLocation().state || {}; // { familySize, destination?, initialQuery?, accommodation? }
  const [details, setDetails] = useState(routerState.accommodation || "");
  ...
  const styles = {
    ...
    progressBar: { backgroundColor: "#1559EA", height: "4px", borderRadius: "6px", width: "66.6666%" },
  ...
  const goBack = () => {
    navigate("/profile-setup-1", { state: { ...routerState } });
  };
  ...
  const goNext = () => {
    ...
    navigate("/profile-setup-3", {
      state: { ...routerState, accommodation: v },
    });
  };

  return (
    <div style={styles.modal}>
      {/* Destination chip if we already have a prefill */}
      ...
      <div style={styles.subtitle}>
        eg: rent/buy, shared/owned, budget = $3000, size - 2b2b, near transit, etc...
      </div>
